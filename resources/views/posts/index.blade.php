        ...
        <x-slot name="page">
            ...
            <div class="mb-6 px-3 py-1 rounded-t-md bg-blue-200 border-gray-300 border-2  shadow-md">
                ...
                <div class="flex justify-between items-center">
                    <h2 class="font-semibold md:text-2xl mb-4">Aliančný modlitebný týždeň 2023</h2>

                    <div class="font-bold text-lg flex">

                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px"
                            height="30px" viewBox="0 0 256 256" version="1.1" preserveAspectRatio="xMidYMid">
                            <g>
                                <path
                ...
                <div class="bg-gray-100 p-3 rounded mb-4">
                   <span class="font-semibold">Prihláste sa na online modlitebný týždeň.</span>
                    <ul>
                        <li> <span class="font-bold">Nedeľa</span> 8. Január <span class="font-bold">1.DEŇ – HOSPODIN JE MÔJ
                                PASTIER o 19.00 hod.</span>
                        </li>
                        <li> <span class="font-bold">Pondelok</span> 9. Január <span class="font-bold">2.DEŇ – NEBUDEM MAŤ
                                NEDOSTATOK
                                o 19.00 hod.</span>
                        </li>
                        <li> <span class="font-bold">Utorok</span> 10. Január <span class="font-bold">3.DEŇ – JA SÁM
                                VYHĽADÁM SVOJE OVCE
                                o 19.00 hod.</span>
                        </li>
                        <li> <span class="font-bold">Streda</span> 11. Január <span class="font-bold">4.DEŇ – MOJE OVCE
                                POČUJÚ MÔJ HLAS
                                o 19.00 hod.</span>
                        </li>
                        <li> <span class="font-bold">Štvrtok</span> 12. Január <span class="font-bold">5.DEŇ – KEBY SOM
                                KRÁČAL HOCI UDOLÍM TIEŇOV SMRTI ...
                                o 19.00 hod.</span>
                        </li>
                        <li> <span class="font-bold">Piatok</span> 13. Január <span class="font-bold">6.DEŇ – VODÍ MA PO
                                CESTÁCH SPRAVODLIVOSTI
                                o 19.00 hod.</span>
                        </li>

                        <li> <span class="font-bold">Sobota</span> 14. Január <span class="font-bold">7.DEŇ – MÁM AJ INÉ
                                OVCE
                                o 19.00 hod.</span>
                        </li>
                        <li> <span class="font-bold">Nedeľa</span> 15. Január <span class="font-bold">8.DEŇ – JA SOM
                                DOBRÝ PASTIER
                                o 19.00 hod.</span>
                        </li>
                    </ul>
                ...
                <form action="" class="bg-gray-100 p-3 rounded flex justify-between">
                    <div>
                        <input type="text" name="name" class="border-2 border-gray-500 rounded-md p-2" required
                            placeholder="uveďte svoje meno">
                        <input type="email" name="email" class="border-2 border-gray-500 rounded-md p-2" required
                            placeholder="email na zaslanie linku">
