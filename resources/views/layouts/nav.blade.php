        ...
        <ul class="center">
            <li>
                ...
                @if( session()->has('countUnwatchedVideos') )
                    <span
                        style="color: white; background: red; padding: 0.2rem 0.5rem;margin-left: -.2rem; font-size: 80%; border-radius: 2rem">
            ...
            <article-admin inline-template>
                <div>
                    ...
                    <ul v-cloak v-if="all" @click="toggle()" class="dropdown-menu">
                        <li><a title="Rádio 7 Slovenská redakcia" class="dropdown-item" href="#"
                               onClick="window.open('http://radio7.sk/live-vysielanie','pagename','resizable,height=500,width=470')">Rádio
                                7 sk
                                <img style="height: 16px;margin-bottom: -3px;" src="{{ asset('images/flag-sk.jpg') }}">
                            </a></li>
                        <li><a title="Rádio 7 Česká redakcia" class="dropdown-item" href="#"
                               onClick="window.open('http://listen.play.cz/player.html?shortcut=radio7&format=&v=20200120','pagename','resizable,height=500,width=470')">Rádio
                                7 cz
                        ...
                        <div class="relative">
                            ...
                            <ul v-cloak v-if="all" @click="toggle"
                                ...
                                <li class="p-2 px-6 hover:bg-gray-300">
                                    <a class="hover:text-gray-700" href="{{ route('organization.profile', [auth()->user()->org_id, auth()->user()->slug]) }}">Profil</a>
                                </li>
{{--                                <li title="divider"></li>--}}
                                <li class="p-2 px-6 hover:bg-gray-300 hover:text-gray-700">
