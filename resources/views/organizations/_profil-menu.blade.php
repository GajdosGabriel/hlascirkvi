<div class="flex mb-5 cursor-pointer">
        ...
        <a class="border-2 flex-1  border-gray-100 hover:bg-indigo-600 hover:text-gray-200 w-full bg-indigo-300 text-gray-900 text-center px-2" href="{{ route('event.create') }}">Nové Podujatie</a>
