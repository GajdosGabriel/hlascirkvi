                        ...
                        <div class="text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <form @submit.prevent="savePrayer">
                                <div class="flex flex-col">
                                    ...
                                    <input type="text" v-model="form.title" required autofocus
                                           class="border-2 border-gray-400 rounded-md p-2" id="title"
                                           plaveholder="Nadpis modlitby">
                                    <span class="text-sm italic">Krátko o Vašom modltitbovom úmysle, napr: za uzdravenie manžela, za prácu a pod.</span>
                                </div>

                                <div class="flex flex-col mt-3 ">
                                    <label for="body" style="font-weight: bold;">Viac o úmysle</label>
                                    <textarea v-model="form.body" required
                                              class="border-2 border-gray-400 rounded-md p-2" rows="5"
                                              id="body"></textarea>
                                    <span class="text-sm italic">Tu napíšte viac o dôvode modlitby, aby Vám ostatní mohli lepšie porozumieť.</span>
                                </div>
                                ...
                                <div class="flex flex-col mt-3 ">
                                    ...
                                    <span
                                        class="text-sm italic">Pre ostatných, aby vedeli, ako Vás osloviť v modlitbe.</span>
                                </div>
                                ...
                                <div class="flex flex-col" v-if="! authUser">
                                    ...
                                    <span class="text-sm italic">Email sa nikde nezverejňuje a je potrebný na overenie.
                            Zároveň, Vám budú doručené oznámenia, keď sa za Vás niekto pomodlí, alebo napíše.</span>
                                </div>

                                <button type="submit"
                                        class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                                    Uložiť
                                </button>
                            </form>
